...
const Top = () => {
	return (
		<Fragment>
		<div className="navbar-bg" style={{height:'70px'}}></div>
					...
					<div className="search-result">
						...
						<div className="search-item">
							<a href="#">
								...
								</div>Stisla Admin Template</a>
						</div>
						<div className="search-item">
							<a href="#">
								<div className="search-icon bg-primary text-white mr-3">
									<i className="fas fa-laptop"></i>
								</div>Create a new Homepage Design</a>
						</div>
					</div>
				</div>
				*/}
